@if ($user->student && $user->student->studyGroup)
    @if ($user->student->studyGroup->discussion)
    ...
    @else
        <div class="alert alert-info text-white solid">
            Link grup diskusi belum tersedia!
        </div>
    @endif
@else
