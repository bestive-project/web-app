                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                @foreach ($liveClass->logRecordings as $logRecording)
                                    <tr>
    ...
    <div class="modal fade" id="addLogRecordingModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('web.log-recording.store') }}" method="post" id="formAddLiveClass">
                    @csrf
                    <input type="hidden" value="{{ $liveClass->uuid }}" name="live_class_id">
