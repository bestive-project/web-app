    ...
    <div class="modal fade" id="addUserModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('web.teacher.store') }}" method="post" id="formAddUser">
                    @csrf
    ...
    <div class="modal fade" id="editUserModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('web.teacher.index') }}" method="post" id="formEditUser">
                    @csrf
                    @method('put')
